...
val engineSerializersModule = SerializersModule {
    ...
    polymorphic(PendingDecision::class) {
        ...
        subclass(OrderTriggeredAbilitiesDecision::class)
    ...
    polymorphic(DecisionResponse::class) {
        ...
        subclass(TriggeredAbilitiesOrderedResponse::class)
    ...
    polymorphic(ContinuationFrame::class) {
        ...
        subclass(ActivatedAbilityPostPaymentContinuation::class)
        subclass(ActivatedAbilityReturnToHandRemainderContinuation::class)
        ...
        subclass(DeferredBlockTriggersContinuation::class)
        subclass(BlockDeclarationSbaBoundaryContinuation::class)
        subclass(BlockDeclarationPostPlacementContinuation::class)
        subclass(TriggerPlacementWaveContinuation::class)
        ...
        subclass(DrawCardAfterZoneChangeContinuation::class)
        ...
        subclass(MoveCollectionOrderedLibraryRemainderContinuation::class)
        subclass(MoveCollectionCommanderRemainderContinuation::class)
        ...
        subclass(RevealLibraryMoveAfterReplacementContinuation::class)
        subclass(DiscoverHandMoveAfterReplacementContinuation::class)
        ...
        subclass(BottomLibraryMoveRemainderContinuation::class)
        subclass(CascadeMayCastAfterBottomContinuation::class)
        subclass(DiscoverMayCastAfterBottomContinuation::class)
        ...
        subclass(CastSpellPostAdditionalCostsContinuation::class)
        subclass(CastSpellAlternativeBounceContinuation::class)
        ...
        subclass(ZoneChangePerformContinuation::class)
        subclass(DeferredStackZoneMoveContinuation::class)
        subclass(ReplacementResolveContinuation::class)
        subclass(CostPaymentReturnToHandContinuation::class)
