 ...
 * trade that returns a tapped creature to trigger the payoff. The ETB reads the durable
 * "cast using web-slinging" flag via [Conditions.WebSlungCostWasPaid] (CR 702.188), so it fires the
 * bonus only on a web-slung cast.
 */
